...
const _jsxFileName = "/Users/nickdejesus/Code/hooks/use-shopping-cart/use-shopping-cart/react/index.js";const CartContext = React.createContext(initialState);
...
function CartProvider({ loading = null, children, ...props }) {
  ...
  if (props.shouldPersist && isClient) {
    ...
    return (
      React.createElement(Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 33}}
        , React.createElement(PersistGate, { persistor: persistor, __self: this, __source: {fileName: _jsxFileName, lineNumber: 34}}, () => children)
      )
    )
  } else {
    return (
      React.createElement(Provider, { context: CartContext, store: store, __self: this, __source: {fileName: _jsxFileName, lineNumber: 39}}
        , children
      )
    )
  }
...
function DebugCart(props) {
  ...
  const cartPropertyRows = Object.entries(cart)
    ...
    .map(([key, value]) => (
      React.createElement('tr', { key: key, __self: this, __source: {fileName: _jsxFileName, lineNumber: 67}}
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 68}}, key)
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 69}}
          , typeof value === 'object' ? (
            React.createElement('button', { onClick: () => console.log(value), __self: this, __source: {fileName: _jsxFileName, lineNumber: 71}}, "Log value" )
          ) : (
  ...
  return (
    React.createElement('div', {
      ...
      , React.createElement('table', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 94}}
        , React.createElement('thead', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 95}}
          , React.createElement('tr', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 96}}
            , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 97}}, "Key")
            , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 98}}, "Value")
          )
        )
        , React.createElement('tbody', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 101}}, cartPropertyRows)
      )
    )
  )
}
