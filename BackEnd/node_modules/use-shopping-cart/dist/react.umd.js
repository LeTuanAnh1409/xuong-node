...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@reduxjs/toolkit'), require('date-fns'), require('uuid'), require('redux-persist'), require('@stripe/stripe-js'), require('react-redux'), require('redux-persist/integration/react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@reduxjs/toolkit', 'date-fns', 'uuid', 'redux-persist', '@stripe/stripe-js', 'react-redux', 'redux-persist/integration/react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.UseShoppingCart = {}, global.React, global.RTK, global.dateFns, global.uuid, global.ReduxPersist, global["@stripe/stripe-js"], global["react-redux"], global["redux-persist/integration/react"]));
})(this, (function (exports, React, toolkit, dateFns, uuid, reduxPersist, stripeJs, reactRedux, react) { 'use strict';
